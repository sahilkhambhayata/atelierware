      ...
      <DropdownMenu end className="dropdown-menu-lg">
        <div className="dropdown-body">
          <ul className="list-apps">
            <li>
              <Link to={`${import.meta.env.PUBLIC_URL}/`} onClick={toggle}>
            ...
            <li>
              <Link to={`${import.meta.env.PUBLIC_URL}/app-chat`} onClick={toggle}>
                <span className="list-apps-media">
            ...
            <li>
              <Link to={`${import.meta.env.PUBLIC_URL}/app-messages`} onClick={toggle}>
                <span className="list-apps-media">
            ...
            <li>
              <Link to={`${import.meta.env.PUBLIC_URL}/app-calender`} onClick={toggle}>
                <span className="list-apps-media">
            ...
            <li>
              <Link to={`${import.meta.env.PUBLIC_URL}/app-file-manager`} onClick={toggle}>
                <span className="list-apps-media">
                  <Icon name="dashlite" className="bg-success-dim"></Icon>
                </span>
            ...
            <li>
              <Link to={`${import.meta.env.PUBLIC_URL}/components`} onClick={toggle}>
                <span className="list-apps-media">
