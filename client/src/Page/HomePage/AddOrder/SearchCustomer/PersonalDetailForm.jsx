...
const PersonalDetailForm = ({ handleCustomerDataChange }) => {
  // const flagIcon = flag();
  ...
  const selectCity = useSelector((state) => state.branch.branch?.City);
  ...
  const [data, setData] = useState({
    name: "",
    address: selectCity ? selectCity : "",
    countryCode: branchData?.country?.CountryCode || "IN",
    countryId: null,
    dialcode: branchData?.country?.Dialcode || "+91",
    mobileNo: "",
    email: "",
    CustTypeId: null,
    // CustType: "",
  ...
  const handleDataChange = (e) => {
    ...
    // handleCustomerDataChange({ newData });
  };
  ...
  useEffect(() => {
    handleCustomerDataChange({ data, image });
  }, [data, image]);
  ...
  return (
    <div>
      <Form>
                              ...
                              return (
                                <>
                                  <DropdownItem
                                    ...
                                    onClick={() => handleType(item.CustTypeId)}
                                  >
        ...
        {/* <div className="d-flex w-full justify-content-between"></div> */}
        ...
        <div className="bg-light my-2 py-2 px-5  updateCustomerDetail">
          <div className="row align-items-center  ">
            ...
            >
              <div>
                <div className="d-flex align-items-center">
                  <img src={AnniversoryIcon} alt="" className="" width="25px" />
                  <DatePicker
            ...
            >
              <div className="mt-4px">
                <UncontrolledDropdown
                  ...
                  toggle={() => setIsDropdownOpenStatus(!isDropdownOpenStatus)}
                >
                  <DropdownToggle
                    tag="a"
                    className=""
                    ...
                    <div className="dropdown-body">
                      <div className=" p-2">
                        <ul>
                          ...
                          >
                            <img src={CorporateIcon} alt="" className="mr-2" />
                            Corporate
                          </DropdownItem>
                        </ul>
                      </div>
            ...
            >
              <div className="d-flex w-100">
                <img src={TinIcon} alt="" className="mr-2 align-items-center" />
                <div className="">
                  <input
                    type="text"
                    id="default-01"
