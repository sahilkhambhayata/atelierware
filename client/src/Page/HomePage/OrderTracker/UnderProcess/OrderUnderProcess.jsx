...
import CustomPaidCell from "./CustomPaidCell";
import CustomBalanceCell from "./CustomBalanceCell";
import CustomUnderProcessCell from "./CustomUnderProcessCell";
import CustomReadyDelivereCell from "./CustomReadyDelivereCell";
...
const OrderUnderProcess = ({
  ...
  const [defaultColumnWidths] = useState([
    ...
    { columnName: "commitments", width: 180 },
    { columnName: "status", width: 150 },
    { columnName: "designer", width: 200 },
    // { columnName: "underprocess", width: 160 },
    // { columnName: "readyfordelivered", width: 180 },
    { columnName: "value", width: 170 },
    { columnName: "paid", width: 200 },
  ...
  order?.order?.orderDetails?.forEach((val, ind) => {
    rows.push({
      ...
      // underprocess: (
      //   <CustomUnderProcessCell
      //     underprocessData={{
      //       index: ind,
      //       // processDate: "11/02/2024"
      //       processDate: new Date(),
      //     }}
      //   />
      // ),
      // readyfordelivered: (
      //   <CustomReadyDelivereCell
      //     delivereData={{
      //       index: ind,
      //       data: "6/10",
      //     }}
                  ...
                  {apiCallCompleted && order.isLoader ? (
                    ...
                    <Grid
                      ...
                      columns={[
                        ...
                        // { name: "underprocess", title: "Under Process" },
                        // { name: "readyfordelivered", title: "Ready For Delivered" },
...
export default OrderUnderProcess;
