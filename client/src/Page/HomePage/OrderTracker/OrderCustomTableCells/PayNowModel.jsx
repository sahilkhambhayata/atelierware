...
const PayNowModel = ({
  ...
  localStorage.setItem(`customerId${tabId}`, AccountId);
  ...
  useEffect(() => {
    const value = orderList?.orderData?.Order?.OrdAmt;
    // const value = 123.34;
  ...
  }, [orderList?.orderData?.Order?.OrdAmt]);
  ...
  const handleSubmitPayment = () => {
    ...
    const data = {
      ...
      VouDate: getCurrentDate(),
      TotalMakingAmt: orderList?.orderData?.Order?.totalMakingamt,
      TSGSTAmt: orderList?.orderData?.Order?.TSGSTAmt,
      TCGSTAmt: orderList?.orderData?.Order?.TCGSTAmt,
      TotalFabricAmt: orderList?.orderData?.Order?.TotalFabAmt,
      taxamt: orderList?.orderData?.Order?.TaxAmt,
      RoundAmt: roundAmt,
      TotalAccessoriesAmt: orderList?.orderData?.Order?.AccessoryAmt
        ? orderList?.orderData?.Order?.AccessoryAmt
        : 0,
    };
                ...
                >
                  <div className="cust-min-h">
                    ...
                    <input
                      ...
                      placeholder="5000"
                      min="1"
                      max={orderList?.orderData?.Order?.OrdAmt || ""}
                    />
                  </div>
              ...
              >
                ...
                <div className="fw-bold w-100 bg-light d-flex justify-content-between align-items-center border px-3 rounded-2 py-1 bg-gray10">
                  ...
                  <div className="w-25">
                    <div
                      // style={{ backgroundColor: "#E4E6EA" }}
                      className="p-1 text-center rounded-2 py-2 bg-gray1"
                    >
                      <span>
                ...
                <div className="bg-gray2 p-2 border-bottom d-flex justify-content-between my-2">
                  ...
                  <span className="fw-bold mr-4">
                    ...
                    {(
                      orderList?.orderData?.Order?.OrdAmt -
                      (sum + orderList?.orderData?.Order?.TotalPaid)
                    ...
                    <div className="mt-2 d-flex cust-d-collumn">
                      ...
                      <div className="w-100">
                        ...
                        <input
                          ...
                          max={getCurrentDate()}
                          min={orderList?.orderData?.Order?.TOrdDate}
                          // {...register("date", {
