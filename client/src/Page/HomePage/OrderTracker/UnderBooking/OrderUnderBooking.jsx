...
import CustomMoreCell from "./CustomMoreCell";
...
const OrderUnderBooking = ({
  ...
  const [selectedDeleteRow, setSelectedDeleteRow] = useState(selectedRows);
  const [isSidebarOpen, setSidebarOpen] = useState(false);
  const [currentCangePage, setCurrentChangePage] = useState(currentPage);

  const [defaultColumnWidths] = useState([
    // { columnName: "order", width: 280 },

    { columnName: "order", align: "left", width: 280 },
      ...
      order: (
        <CustomOrderCell
          orderData={{
            ...
            mainId: `${val?.TOrdHdID}`,
            // urgentIcon: val?.MstOrderType?.OrderType,
            urgentData: {
...
export default OrderUnderBooking;
