...
import DeleteSrNo from "./DeleteColumn/DeleteSrNo";
...
const EditItemSliderSingle = ({ toggleSidebar, selectedRows }) => {
  ...
  let deleteRows = [];
  const order = useSelector((state) => state?.itemDetails.item.orderItemList);
  ...
  const handleVerify = () => {
    ...
    try {
      ...
      if (res.success) {
          ...
          (res) => {
            if (res.success) {
              res.Order.TOrdDtls.forEach((item) => {
                ...
                if (item.TOrdDtId === selectedRows.TOrdDtId) {
                  results.push(item);
                  localStorage.setItem(
                    `TOrdDtID${tabId}`,
                    selectedRows.TOrdDtId
                  );
                }
              });
            ...
            if (isGroupOrder) {
              const sendingData = {
                AccountId: selectedRows.orderHead.AccountId,
                ...
                TOrdNo: selectedRows.orderHead.TOrdNo,
              };
              ...
              const sendingData = {
                ...
                mood: "edit",
                tab: "other",
                ItemId: selectedRows.ItemId,
                TOrdDtID: selectedRows.TOrdDtID,
                TOrdNo: selectedRows.orderHead.TOrdNo,
              };
        ...
        dispatch(getSingleOrderDtlsAsyncData(selectedRows.TOrdHdID));
        // .then(
        //   (res) => {
        ...
        //       mood: "edit",
        //       tab: "other",
        //       balanceData: selectedRows,
        //       TOrdNo: selectedRows.orderHead.TOrdNo,
        //     };
        //     const url = `/#/order-tracker-single-order/${selectedRows.orderHead.TOrdNo}/edit`;
        //     const a = document.createElement("a");
        //     a.href = url;
        //     a.target = "_blank";
        //     a.rel = "noopener noreferrer";
  ...
  const [defaultDeleteColumnWidths] = useState([
    // { columnName: "orderno", width: 120 },
    { columnName: "customer", width: 150 },
    // { columnName: "commitment", width: 250 },
  ...
  return (
    <div>
      ...
      <div className="d-flex align-items-center mt-2 mb-2">
        <span className="fs-5 fw-bold">Edit Item</span>
      ...
      <div className="mt-2 mb-2">
        <span className="fs-5 fw-bold ">selected  Item</span>
      </div>
      ...
      <div className="order-table ">
        <div
          className="ordered-table overflow-x-hidden"
      ...
      <div className="mt-2 w-50 p-2">
        <div>An OTP will be send to your registered Email Address</div>
        <div>
...
export default EditItemSliderSingle;
