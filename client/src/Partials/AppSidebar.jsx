...
const AppSidebar = () => {
  ...
  const appSidebarClass = classNames({
    ...
    [`is-${theme.appbar}`]:
      theme.appbar !== "white" && theme.appbar !== "light",
  });
        ...
        <div className="nk-sidebar-body">
          <SimpleBar className="nk-sidebar-content">
            <div className="nk-sidebar-menu">
              <ul className="nk-menu apps-menu">
                          ...
                          return (
                            <React.Fragment key={idx}>
                              ...
                              <li
                                ...
                                id={"app" + idx}
                              >
                                <Link to={sub.link} className="nk-menu-link">
                                  <span className="nk-menu-icon">
                ...
                <li
                  className={`nk-menu-item ${
                    currentUrl === import.meta.env.PUBLIC_URL + "/components"
                      ? "active current-page"
                      : ""
                  }`}
                  id="componentTooltip"
                >
                  <Link
                    to={`${import.meta.env.PUBLIC_URL}/components`}
            ...
            <div className="nk-sidebar-footer">
              <ul className="nk-menu">
                ...
                <li className="nk-menu-item" id="settingsTooltip">
                  <Link
                    to={`${import.meta.env.PUBLIC_URL}/user-profile-setting`}
                    className="nk-menu-link"
                  >
                    <span className="nk-menu-icon">
          ...
          >
            ...
            <DropdownMenu end className="dropdown-menu-md ms-4">
              ...
              <div className="dropdown-inner">
                <LinkList>
                  <a href={`${import.meta.env.PUBLIC_URL}/auth-login`}>
